...
export const Header = () => {
  ...
  return (
    <header className="max-w-[90%] lg:max-w-[80%] 3xl:max-w-[1560px] 4xl:max-w-[1800px] mx-auto flex justify-between items-center mt-8 absolute top-0 left-0 right-0 z-[100] bg-white">
